#!/bin/bash
python train.py --experiment_name la-bilinear-margin1-color+translation+cutout-d1g1-DiffAugment-biggan-cifar100-0.2 --DiffAugment color,translation,cutout \
